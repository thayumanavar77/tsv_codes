...
abstract class TweetSet {
  ...
  def mostRetweetedAcc(maxAcc: Tweet): Tweet
  /**
...
class Empty extends TweetSet {
  ...
  def mostRetweetedAcc(maxAcc: Tweet) = maxAcc
  def mostRetweeted: Tweet= throw new java.util.NoSuchElementException("No such element")
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
    ...
    def mostRetweetedAcc(maxAcc: Tweet): Tweet =
      right.mostRetweetedAcc(left.mostRetweetedAcc(
                             if ( elem.retweets > maxAcc.retweets ) elem else maxAcc))
